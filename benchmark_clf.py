...
# siam with no pp 
# args.use_pp_prediction = False 
# args.siam_model_fn = './save/siam_L/model_best.pt'

# siam wuith pp 
# args.use_pp_prediction = True 
# args.siam_model_fn = './save/siam_pp_L/model_best.pt'

# only property
args.use_pp_prediction = True 
args.siam_model_fn = './save/pp_L/model_best.pt'
